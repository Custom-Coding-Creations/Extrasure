...
export type AuditAction =
  ...
  | "triage_photo_uploaded"
  | "triage_follow_up_queued"
  | "triage_kill_switch_toggled"
  | "triage_threshold_adjusted"
  | "triage_retention_run"
  | "triage_assessment_overridden"
  | "triage_webhook_created"
  | "triage_webhook_deleted"
