...
export function SiteChatbotPanel({ onClose, handoff }: SiteChatbotPanelProps) {
  ...
  return (
    <section className="flex max-h-[min(85vh,48rem)] w-[min(94vw,24rem)] flex-col overflow-hidden rounded-2xl border border-[#c9b797] bg-[#fff8ea] shadow-[0_18px_40px_rgba(17,35,28,0.25)]">
