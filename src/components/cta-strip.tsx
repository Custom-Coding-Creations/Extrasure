...
export function CtaStrip() {
  return (
    <section className="mx-auto mt-14 w-full max-w-6xl px-4 pb-6 sm:px-6 lg:px-8">
      <div className="rounded-[2rem] border p-8 shadow-lg sm:flex sm:items-center sm:justify-between sm:gap-8" style={{ borderColor: "rgba(255,255,255,0.82)", background: "linear-gradient(145deg, #e8edf4 0%, #dfe7f0 100%)", color: "#44596f", boxShadow: "var(--shadow-md)" }}>
        <div>
        ...
        <div className="mt-5 flex flex-wrap gap-3 sm:mt-0">
          ...
          <Link href="/contact" className="rounded-full border px-5 py-2 text-sm font-semibold transition hover:bg-white hover:text-[#44596f]" style={{ borderColor: "rgba(255,255,255,0.82)", color: "#44596f", background: "#e8edf4", boxShadow: "var(--shadow-sm)" }}>
